...
void Game::ResetLevel() {
    if (this->Level == 0)
        this->Levels[0].Load("Content/levels/one.lvl", this->Width, this->Height / 2);
    else if (this->Level == 1)
        this->Levels[1].Load("Content/levels/two.lvl", this->Width, this->Height / 2);
    else if (this->Level == 2)
        this->Levels[2].Load("Content/levels/three.lvl", this->Width, this->Height / 2);
    else if (this->Level == 3)
        this->Levels[3].Load("Content/levels/four.lvl", this->Width, this->Height / 2);
}
